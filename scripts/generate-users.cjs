...
let md = `# 👥 StellarRise — 70 Midnight Preprod Beta Users Registry
...
console.log('Successfully generated docs/PREPROD_USERS.md and docs/submission/preprod-users.md for 70 users');
