        ...
        <div className="flex items-center gap-3">
          ...
          {wallet.isConnected ? (
            <div className="relative flex items-center gap-2">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-purple-600/30 flex items-center justify-center text-purple-300 font-mono text-xs">
                  ZK
                </div>
                <div>
              ...
              {showWitnessDetails && (
                <div className="absolute right-0 top-14 w-84 bg-[#0d1224] border border-[var(--border-active)] rounded-2xl shadow-2xl p-4 z-50">
                  ...
                  <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between">
                    <span className="text-[11px] text-slate-400">Lace Midnight Connected</span>
                    <button
